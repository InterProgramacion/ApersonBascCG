...
Partial Class Rview_Usuarios
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Rview_Usuarios))
        Me.TransporteBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DataSet7 = New AperBascu.DataSet7()
        ...
        Me.DataSet6 = New AperBascu.DataSet6()
        Me.usuarioBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.usuarioTableAdapter = New AperBascu.DataSet6TableAdapters.usuarioTableAdapter()
        Me.TransporteTableAdapter = New AperBascu.DataSet7TableAdapters.TransporteTableAdapter()
        CType(Me.TransporteBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        '
        Me.TransporteBindingSource.DataMember = "Transporte"
        Me.TransporteBindingSource.DataSource = Me.DataSet7
        '
        'DataSet7
        '
        ...
        ReportDataSource1.Name = "DataUsuario"
        ReportDataSource1.Value = Me.usuarioBindingSource
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource1)
        Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "AperBascu.ReporteUsuario.rdlc"
        ...
        Me.usuarioBindingSource.DataSource = Me.DataSet6
        '
        'usuarioTableAdapter
        '
        ...
        '
        Me.TransporteTableAdapter.ClearBeforeFill = True
        '
        'Rview_Usuarios
        '
        ...
        Me.Name = "Rview_Usuarios"
        Me.Text = "Reporte Listado Usuarios"
        Me.WindowState = System.Windows.Forms.FormWindowState.Maximized
        CType(Me.TransporteBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents DataSet6 As AperBascu.DataSet6
    Friend WithEvents usuarioTableAdapter As AperBascu.DataSet6TableAdapters.usuarioTableAdapter
    Friend WithEvents TransporteBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents DataSet7 As AperBascu.DataSet7
    Friend WithEvents TransporteTableAdapter As AperBascu.DataSet7TableAdapters.TransporteTableAdapter
