...
Public Class RepAnalisaBL6
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AperBascu.RepAnalisaBL6.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepAnalisaBL6
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepAnalisaBL6 = New RepAnalisaBL6()
        rpt.Site = Me.Site
        Return rpt
    End Function
