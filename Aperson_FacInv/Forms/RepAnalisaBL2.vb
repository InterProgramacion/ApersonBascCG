...
Public Class RepAnalisaBL2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AperBascu.RepAnalisaBL2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepAnalisaBL2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepAnalisaBL2 = New RepAnalisaBL2()
        rpt.Site = Me.Site
        Return rpt
    End Function
