Public Class frmRegistroCertificado
...
#Region "Consulta"
    ...
    Private Sub Consulta(ByVal _codigo As String)
        Try
            ...
            If _codigo = String.Empty Then
                dTable = Datos.consulta_reader("SELECT TOP 1 * FROM dbo.registCertifica ORDER BY Id_reg")
            Else
                dTable = Datos.consulta_reader("SELECT * FROM dbo.registCertifica WHERE Id_reg=" & _codigo)
            End If
            ...
            For Each dRow As DataRow In dTable.Rows
                ...
                txtMarca.Text = dRow.Item("marca_reg").ToString
                TxtModelo.Text = dRow.Item("modelo_reg").ToString
    ...
    Private Sub Navega()
        'Contar Lineas
        dTable = Datos.consulta_reader("SELECT Count(1) As TotRec FROM dbo.registCertifica")
        Me.TotLineas = dTable.Rows.Item(0).Item("TotRec")

        'Primera Linea
        dTable = Datos.consulta_reader("SELECT TOP 1 Id_reg FROM dbo.registCertifica ORDER BY Id_reg")
        Me.PrimLinea = dTable.Rows.Item(0).Item("Id_reg")

        'Ultima Linea
        dTable = Datos.consulta_reader("SELECT TOP 1 Id_reg FROM dbo.registCertifica ORDER BY Id_reg DESC")
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        If ValidaCampos() Then 'Si es verdadero
            If NuevoReg = True Then
                ...
                'Suma Correlativo
                dTable = Datos.consulta_reader("SELECT MAX(Id_reg)+1 rMax FROM [dbo].[registCertifica]")
                ...
                Dim StringSql As String = <sqlExp>
                                        INSERT INTO [dbo].[registCertifica] ([id_reg], [cpn_reg],
	                                                                     [empresaprov_reg],
	                                                                     [marca_reg],
	                                                                     [modelo_reg],
	                                                                     [bascula_reg],
            ...
            Else
                'Se arma el script para grabar SQL
                Dim StringSql As String = <sqlExp>
                                         UPDATE [dbo].[registCertifica] SET [cpn_reg]  =  '<%= txtRegCPN.Text %>',
	                                                                     [empresaprov_reg]  =  '<%= txtProveedor.Text %>',
	                                                                     [marca_reg]  =  '<%= txtMarca.Text %>',
	                                                                     [modelo_reg]  =  '<%= TxtModelo.Text %>',
...
#Region "Botones"
    ...
    Private Sub btnBorrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBorrar.Click
        ...
        Else
            ...
            Datos.consulta_non_query("DELETE FROM [dbo].[registCertifica] WHERE Id_reg='" & txtId.Text & "'")
    ...
    Private Sub BuscaCodigo()
        ...
        stringSQL = "SELECT Id_reg As Codigo, cpn_reg As Nombre, bascula_reg FROM [dbo].[registCertifica]"

        'Script para Filtrar el Grid
        Dim stringSqlFiltro As String = "SELECT Id_reg As Codigo, cpn_reg As Nombre FROM [dbo].[registCertifica] WHERE Id_reg "
...
#Region "Botones Navegar"
    ...
    Private Sub btnAnterior_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnanterior.Click
        'Para Anterior
        dTable = Datos.consulta_reader("SELECT TOP 1 Id_reg FROM dbo.registCertifica WHERE Id_reg <" & Me.LineaActual & "ORDER BY Id_reg DESC")
    ...
    Private Sub btnSiguiente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsiguiente.Click
        'Para Sigiente
        dTable = Datos.consulta_reader("SELECT TOP 1 Id_reg FROM dbo.registCertifica WHERE Id_reg >" & Me.LineaActual & "ORDER BY Id_reg")
