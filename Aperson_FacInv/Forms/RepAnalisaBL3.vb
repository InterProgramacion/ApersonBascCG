...
Public Class RepAnalisaBL3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AperBascu.RepAnalisaBL3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepAnalisaBL3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepAnalisaBL3 = New RepAnalisaBL3()
        rpt.Site = Me.Site
        Return rpt
    End Function
