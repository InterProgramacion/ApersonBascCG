...
Public Class RepAnalisaBL_Log
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AperBascu.RepAnalisaBL_Log.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepAnalisaBL_Log
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepAnalisaBL_Log = New RepAnalisaBL_Log()
        rpt.Site = Me.Site
        Return rpt
    End Function
