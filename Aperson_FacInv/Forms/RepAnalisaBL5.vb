...
Public Class RepAnalisaBL5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AperBascu.RepAnalisaBL5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepAnalisaBL5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepAnalisaBL5 = New RepAnalisaBL5()
        rpt.Site = Me.Site
        Return rpt
    End Function
