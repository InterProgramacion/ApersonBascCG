...
Public Class CierreTurno2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AperBascu.CierreTurno2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cUsuario() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCierreTurno2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CierreTurno2 = New CierreTurno2()
        rpt.Site = Me.Site
        Return rpt
    End Function
